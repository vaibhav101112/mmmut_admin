...
public class UploadImage extends AppCompatActivity {
    ...
    ProgressDialog pd;
    private DatabaseReference reference,rRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance("gs://mmmut-82969.appspot.com").getReference().child("gallery");
        pd = new ProgressDialog(this);

        String[] items = new String[]{"Select Category","Convocation","Independence Day","Republic Day","Others Event"};
    ...
    private void uploadData() {
        rRef = reference.child(category);
        final String uniqueKey = reference.push().getKey();

        rRef.child(uniqueKey).setValue(downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
