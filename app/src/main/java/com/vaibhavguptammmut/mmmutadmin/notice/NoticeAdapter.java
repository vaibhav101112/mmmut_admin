package com.vaibhavguptammmut.mmmutadmin.notice;
                ...
                builder.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                DatabaseReference reference = FirebaseDatabase.getInstance("https://mmmut-82969-default-rtdb.firebaseio.com/").getReference().child("Notice");
